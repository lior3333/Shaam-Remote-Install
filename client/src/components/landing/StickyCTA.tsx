    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          animate={{ y: 0 }}
          exit={{ y: 100 }}
          className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] p-4 md:hidden"
          role="region"
          aria-label="כפתור התקשרות דחוק בתחתון"
        >
          <Button 
